...
import { useGetApplicationsQuery, useGetAuthUserQuery } from "@/src/state/api";
...
const Applications = () => {
  ...
  if (isError || !applications)
    return (
      <div className="dashboard-container">Error fetching applications</div>
    );
  ...
  return (
    <div className="dashboard-container">
      <Header
        title="Applications"
        subtitle="Track and manage applications your rental applications"
      />
