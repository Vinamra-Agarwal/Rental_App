...
import { Lease, Payment, Property } from "@/src/types/prismaTypes";
import { ArrowDownToLineIcon, Check, CreditCard, Download, Edit, FileText, Mail, MapPin } from "lucide-react";
...
const Residence = () => {
  ...
  if (!property || propertyError) {
    return <div className="dashboard-container">Error loading property</div>;
  }
