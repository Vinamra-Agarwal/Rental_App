...
import { AmenityIcons, PropertyTypeIcons } from "@/src/lib/constants";
import { cleanParams, cn, formatEnumString } from "@/src/lib/utils";
import { FiltersState, initialState, setFilters } from "@/src/state";
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <Slider
            ...
            step={100}
            value={[
              localFilters.priceRange[0] ?? 2500,
          ...
          <div className="flex justify-between mt-2">
            <span>₹{localFilters.priceRange[0] ?? 2500}</span>
            <span>₹{localFilters.priceRange[1] ?? 50000}</span>
          </div>
        </div>
